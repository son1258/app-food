...
function Chat() {
    ...
    return (
        <div className="sm:hidden font-[Poppins] relative">
            ...
            <div className="chat-box h-96 overflow-y-auto flex flex-col p-4">
                {messages.map((msg, index) => (
                    <div key={index} className="float-right mt-5 bg-red-500 text-sm text-white rounded-l-[15px] rounded-br-[15px]">
                        <p className="px-3 py-2">{msg}</p>
                    </div>
                ))}
            </div>
            </div>
            <div className="mt-[106px] mx-6 flex justify-between mb-9">
                ...
                <div className="ml-[12px] h-[56px] bg-[#F9FAFB] flex justify-between">
                    <input type="text" value={inputText} className="text-[14px] text-[#00000080]/50 font-[700]" placeholder="Food Runs typing....." onChange={(e) => setInputText(e.target.value)}></input>
